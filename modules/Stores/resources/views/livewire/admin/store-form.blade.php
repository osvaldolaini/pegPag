    ...
    <form>
        <x-layouts.admin.tabs.tabs>
            <x-slot name="nav">
                ...
                <x-layouts.admin.tabs.tabs-link tab="tab3">
                    <x-slot name="svg">
                        <x-svg.qrcode
                            class="w-5 h-5 transition duration-75 shrink-0 text-primary-600 dark:text-primary-400"></x-svg.qrcode>

                    </x-slot>
                    <x-slot name="title">PIX</x-slot>
                </x-layouts.admin.tabs.tabs-link>
            </x-slot>
            <x-slot name="content">
                    ...
                    <div id="tab2" x-show="activeTab === '#tab2'">
                        <div class="col-span-full sm:col-span-3">
                            ...
                            @elseif ($photo)
                                ...
                                <img src="{{ url('storage/stores/' . $photo) }}" wire:model="photo">
                            @else
                                <div class="col-span-full sm:col-span-3">
                    ...
                    <div role="tabpanel"
                        ...
                        <div class="grid grid-cols-2 gap-2 mb-1 sm:grid-cols-6 sm:gap-3 sm:mb-5">
                            <div class="col-span-4">
                                <label for="name" class="block text-sm font-medium text-gray-900 dark:text-white">
                                    Chave pix</label>
                                <input type="text" wire:model="key_pix" placeholder="Chave pix" required
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                @error('key_pix')
                                    <span class="error">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-span-full sm:col-span-3">
                                <label class="block text-sm font-medium text-gray-900 dark:text-white"
                                    for="city_pix">Codigo da Cidade pix</label>
                                <input required
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Cidade" readonly wire:model="city_pix">
                            </div>
                        </div>
                    </div>
                </div>
