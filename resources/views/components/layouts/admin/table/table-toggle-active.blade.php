@props(['id', 'active', 'class' => ''])

@if ($active == 1)
    <div class="p-0 tooltip tooltip-top {{ $class ?? '' }}" data-tip="Desativar">
        <div class="mr-1 md:hidden">
            DESATIVAR
        </div>
        <button wire:click="buttonActive({{ $id }})"
            class="p-1 text-green-500 transition-colors duration-200 whitespace-nowrap">
            <svg class="w-5 h-5 md:w-8 md:h-8 " viewBox="0 -6 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg"
...
@else
    <div class="p-0 tooltip tooltip-top {{ $class ?? '' }}" data-tip="Ativar">
        <div class="mr-1 md:hidden">
            ATIVAR
        </div>
        <button wire:click="buttonActive({{ $id }})"
            class="p-1 text-red-500 transition-colors duration-200 whitespace-nowrap">
            <svg class="w-6 h-6 md:w-8 md:h-8" viewBox="0 -6 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
